...
mean_a_inf_mcmc = np.array(pd.read_csv('MCMC_output/mean_a_inf_mcmc.csv'))[0:nsamp,1:]
mean_B_inf_mcmc = np.array(pd.read_csv('MCMC_output/mean_B_inf_mcmc.csv'))[0:nsamp,1:]
mean_e_inf_mcmc = np.array(pd.read_csv('MCMC_output/mean_e_inf_mcmc.csv'))[0:nsamp,1:]
std_e_inf_mcmc = np.array(pd.read_csv('MCMC_output/std_a_inf_mcmc.csv'))[0:nsamp,1:]
std_a_inf_mcmc = np.array(pd.read_csv('MCMC_output/std_B_inf_mcmc.csv'))[0:nsamp,1:]
std_B_inf_mcmc = np.array(pd.read_csv('MCMC_output/std_e_inf_mcmc.csv'))[0:nsamp,1:]

mean_a_10_mcmc = np.array(pd.read_csv('MCMC_output/mean_a_10_mcmc.csv'))[0:nsamp,1:]
mean_B_10_mcmc = np.array(pd.read_csv('MCMC_output/mean_B_10_mcmc.csv'))[0:nsamp,1:]
mean_e_10_mcmc = np.array(pd.read_csv('MCMC_output/mean_e_10_mcmc.csv'))[0:nsamp,1:]
std_e_10_mcmc = np.array(pd.read_csv('MCMC_output/std_a_10_mcmc.csv'))[0:nsamp,1:]
std_a_10_mcmc = np.array(pd.read_csv('MCMC_output/std_B_10_mcmc.csv'))[0:nsamp,1:]
std_B_10_mcmc = np.array(pd.read_csv('MCMC_output/std_e_10_mcmc.csv'))[0:nsamp,1:]

mean_a_5_mcmc = np.array(pd.read_csv('MCMC_output/mean_a_5_mcmc.csv'))[0:nsamp,1:]
mean_B_5_mcmc = np.array(pd.read_csv('MCMC_output/mean_B_5_mcmc.csv'))[0:nsamp,1:]
mean_e_5_mcmc = np.array(pd.read_csv('MCMC_output/mean_e_5_mcmc.csv'))[0:nsamp,1:]
std_e_5_mcmc = np.array(pd.read_csv('MCMC_output/std_a_5_mcmc.csv'))[0:nsamp,1:]
std_a_5_mcmc = np.array(pd.read_csv('MCMC_output/std_B_5_mcmc.csv'))[0:nsamp,1:]
std_B_5_mcmc = np.array(pd.read_csv('MCMC_output/std_e_5_mcmc.csv'))[0:nsamp,1:]

mean_a_2_mcmc = np.array(pd.read_csv('MCMC_output/mean_a_2_mcmc.csv'))[0:nsamp,1:]
mean_B_2_mcmc = np.array(pd.read_csv('MCMC_output/mean_B_2_mcmc.csv'))[0:nsamp,1:]
mean_e_2_mcmc = np.array(pd.read_csv('MCMC_output/mean_e_2_mcmc.csv'))[0:nsamp,1:]
std_e_2_mcmc = np.array(pd.read_csv('MCMC_output/std_a_2_mcmc.csv'))[0:nsamp,1:]
std_a_2_mcmc = np.array(pd.read_csv('MCMC_output/std_B_2_mcmc.csv'))[0:nsamp,1:]
std_B_2_mcmc = np.array(pd.read_csv('MCMC_output/std_e_2_mcmc.csv'))[0:nsamp,1:]
